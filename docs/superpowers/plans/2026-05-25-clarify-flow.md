...
epic:    clarify-c4h.1
tasks:
  - clarify-c4h.1.1  Task 0.1: Install dependencies
  - clarify-c4h.1.2  Task 0.2: Configure TypeScript and esbuild for TSX
  - clarify-c4h.1.3  Task 0.3: Set up vitest
  - clarify-c4h.1.4  Task 0.4: Rename plugin in manifest and package
  - clarify-c4h.1.5  Task 0.5: Replace sample main.ts with a minimal stub
  - clarify-c4h.1.6  Task 1.1: Item schema
  - clarify-c4h.1.7  Task 1.2: Outcome schema
  - clarify-c4h.1.8  Task 1.3: Settings schema with defaults
  - clarify-c4h.1.9  Task 1.4: Tagged error types
  - clarify-c4h.1.10  Task 2.1: VaultService
  - clarify-c4h.1.11  Task 2.2: MetadataService
  - clarify-c4h.1.12  Task 2.3: ProjectService
  - clarify-c4h.1.13  Task 3.1: moveAndRewrite primitive
  - clarify-c4h.1.14  Task 3.2: readInbox
  - clarify-c4h.1.15  Task 3.3: applyOutcome dispatcher (simple outcomes)
  - clarify-c4h.1.16  Task 3.4: Project outcome (new project + first next action)
  - clarify-c4h.1.17  Task 4.1: itemMachine — events, context, decision tree
  - clarify-c4h.1.18  Task 4.2: itemMachine — back navigation
  - clarify-c4h.1.19  Task 4.3: sessionMachine
  - clarify-c4h.1.20  Task 5.1: Shared components
  - clarify-c4h.1.21  Task 5.2: ClarifyView (Obsidian ItemView) and Wizard root
  - clarify-c4h.1.22  Task 5.3: BinaryQuestion screen
  - clarify-c4h.1.23  Task 5.4: MultiOption screen
  - clarify-c4h.1.24  Task 5.5: ProjectPicker screen
  - clarify-c4h.1.25  Task 5.6: DatePicker, WaitingForInput, NextActionAttrs screens
  - clarify-c4h.1.26  Task 5.7: ProjectOutcome, SessionComplete, EmptyInbox, and wizard wiring
  - clarify-c4h.1.27  Task 5.8: Keyboard and swipe input
  - clarify-c4h.1.28  Task 6.1: Settings tab UI
  - clarify-c4h.1.29  Task 6.2: Plugin entry — main.ts
  - clarify-c4h.1.30  Task 6.3: End-to-end integration test
  - clarify-c4h.1.31  Task 7.1: Symlink built plugin into a real vault and smoke-test on desktop
  - clarify-c4h.1.32  Task 7.2: Mobile smoke test
-->
